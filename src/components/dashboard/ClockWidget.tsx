    ...
    <div className="min-h-full p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#FBCFE8' }}>
      ...
      <div className="flex flex-col items-center flex-1 justify-center">
        <div className="flex items-baseline">
          <span className="font-mono text-5xl font-bold tracking-tight text-[var(--color-text-primary)]">{String(h12).padStart(2, '0')}:{String(m).padStart(2, '0')}</span>
          <span className="font-mono text-lg font-semibold text-[var(--color-text-secondary)] ml-0.5">:{String(s).padStart(2, '0')}</span>
        </div>
